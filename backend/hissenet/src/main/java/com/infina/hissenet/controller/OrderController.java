...
public class OrderController {
	...
	@PutMapping()
	public ApiResponse<OrderResponse> updateOrder(@Valid @RequestBody OrderUpdateRequest request) {
		return ApiResponse.ok("Order updated successfully", service.updateOrder(request));
	}
	...
	@PostMapping("/{id}/fill")
	public ApiResponse<OrderResponse> markOrderAsFilled(@PathVariable Long id) {
		return ApiResponse.ok("Order marked as FILLED", service.markAsFilled(id));
	}

	@PostMapping("/{id}/cancel")
	public ApiResponse<OrderResponse> cancelOrder(@PathVariable Long id) {
		return ApiResponse.ok("Order canceled successfully", service.cancelOrder(id));
	}

	@PostMapping("/{id}/reject")
	public ApiResponse<OrderResponse> rejectOrder(@PathVariable Long id) {
		return ApiResponse.ok("Order rejected successfully", service.rejectOrder(id));
	}
}

                            ...
                            <span className="drawer-menu-icon">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3 3V21H21" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                        strokeLinejoin="round" />
                                    <path d="M9 9L12 6L16 10L20 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                        strokeLinejoin="round" />
                                </svg>
                            </span>
                ...
                <Link to={`/wallet/${customerId}`} className="drawer-menu-link" onClick={closeDrawer}>
                    <div className="drawer-menu-header">
                        <div className="drawer-menu-left">
                            <span className="drawer-menu-icon">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M21 12H3M3 12L10 5M3 12L10 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                        strokeLinejoin="round" />
                                </svg>
                            </span>
                    ...
                    <div className="drawer-menu-header">
                        <div className="drawer-menu-left">
                            <span className="drawer-menu-icon">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M1 4V16C1 16.5304 1.21071 17.0391 1.58579 17.4142C1.96086 17.7893 2.46957 18 3 18H21C21.5304 18 22.0391 17.7893 22.4142 17.4142C22.7893 17.0391 23 16.5304 23 16V4C23 3.46957 22.7893 2.96086 22.4142 2.58579C22.0391 2.21071 21.5304 2 21 2H3C2.46957 2 1.96086 2.21071 1.58579 2.58579C1.21071 2.96086 1 3.46957 1 4Z"
                                        stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    <polyline points="1,6 7,13 13,6 21,13" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                                        strokeLinejoin="round" />
                                </svg>
                            </span>
        ...
        <>
            ...
            <li className={`drawer-menu-item ${isActiveMenu('/customers') ? 'active' : ''}`}>
                <Link
                    ...
                    className={`drawer-menu-link ${isProcessing ? 'is-disabled' : ''}`}
                    onClick={(e) => { e.preventDefault(); if (!isProcessing) start(); }}
                    aria-disabled={isProcessing}
                    title={isProcessing ? 'İşlem sürüyor' : 'Müşteri İşlemleri'}
                >                    <div className="drawer-menu-header">
                        <div className="drawer-menu-left">
                            <span className="drawer-menu-icon">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="drawer-menu-link">
                    ...
                    {isCustomerSubmenuOpen && (
                        <div className="drawer-submenu">
                            <Link to="/individual-customer"
                                className={`drawer-submenu-link ${isActiveMenu('/individual-customer') ? 'active' : ''}`}
                                onClick={closeDrawer}>
                                <span className="drawer-submenu-text">Bireysel</span>
                            </Link>
                            <Link to="/corporate-customer"
                                className={`drawer-submenu-link ${isActiveMenu('/corporate-customer') ? 'active' : ''}`}
                                onClick={closeDrawer}>
                        ...
                        <>
                            ...
                            <div className="drawer-footer">
                                <button onClick={handleLogout}
                                    className={`drawer-logout-btn ${isCustomerMenu ? 'back-btn' : ''}`}>                                    <span
                                    ...
                                    <span>{isCustomerMenu ? 'Geri Dön' : 'Çıkış Yap'}</span>
                                </button>
                            </div>
                        </>
                    ) : (
